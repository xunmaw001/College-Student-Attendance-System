    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">大学生考勤系统注册</h1>
                <el-form class="rgs-form" label-width="auto">
                    ...
                    <el-form-item label="重复密码" class="input">
                       ...
                       <!--<el-form-item class="input" label="账户状态">
                        ...
                        -->
                           ...
                           -->
                       <el-form-item class="input" label="班级"> <!--style="width: 399px;height: 40px;"-->
                            <el-select v-model="ruleForm.banjiId" placeholder="请选择班级">
                                <el-option
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // }
                            //// 学生 的 班级
                            // if((!this.ruleForm.banjiId)&& 'xuesheng'==this.tableName){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/daxueshengkaoqin/img/back-img-bg.jpg);
