    ...
    >  
     <el-row>
           ...
           <el-form-item v-if="flag=='laoshi'"  label='工号' prop="laoshiUuidNumber">
               <el-input v-model="ruleForm.laoshiUuidNumber"disabled="true"   placeholder='工号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
...
<!--         <el-col :span="12">
             <el-form-item v-if="flag=='xuesheng'" label='老师' prop="laoshiId">
                 <el-input v-model="banjiForm.laoshiId" disabled></el-input>
             </el-form-item>
         </el-col>-->
         <el-col :span="12">
             <el-form-item v-if="flag=='xuesheng'" label='班级编号' prop="banjiUuidNumber">
                 <el-input v-model="banjiForm.banjiUuidNumber" disabled></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='xuesheng'" label='年级' prop="nianjiTypes">
                 <el-input v-model="banjiForm.nianjiValue" disabled></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
