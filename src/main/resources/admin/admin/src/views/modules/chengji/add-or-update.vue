    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="分数" prop="chengjiFenshu">
                       <el-input v-model="ruleForm.chengjiFenshu"
                                 placeholder="分数" clearable  :readonly="ro.chengjiFenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="分数" prop="chengjiFenshu">
                           <el-input v-model="ruleForm.chengjiFenshu"
