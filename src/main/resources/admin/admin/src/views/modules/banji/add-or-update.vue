    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="班级编号" prop="banjiUuidNumber">
                       <el-input v-model="ruleForm.banjiUuidNumber"
                                 placeholder="班级编号" clearable  :readonly="ro.banjiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="班级编号" prop="banjiUuidNumber">
                           <el-input v-model="ruleForm.banjiUuidNumber"
                                     placeholder="班级编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="年级" prop="nianjiTypes">
                        <el-select v-model="ruleForm.nianjiTypes" :disabled="ro.nianjiTypes" placeholder="请选择年级">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="年级" prop="nianjiValue">
                        <el-input v-model="ruleForm.nianjiValue"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.banjiContent"  label="班级备注" prop="banjiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.banjiContent" label="班级备注" prop="banjiContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   banjiContent: [
                              { required: true, message: '班级备注不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
