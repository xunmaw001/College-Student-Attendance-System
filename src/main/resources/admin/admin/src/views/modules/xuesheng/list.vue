        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/daxueshengkaoqin/upload/xueshengMuBan.xls"
                        >批量导入学生数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('xuesheng','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column label="学号" prop="xueshengUuidNumber" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="学生身份证号" prop="xueshengIdNumber" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.xueshengIdNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column label="学生头像" prop="xueshengPhoto" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center" width="200">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="学生邮箱" prop="xueshengEmail" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.xueshengEmail}}
                        </template>
                    </el-table-column>
                    <el-table-column label="账户状态" prop="jinyongTypes" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
