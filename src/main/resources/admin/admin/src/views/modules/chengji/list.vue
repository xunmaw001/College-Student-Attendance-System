        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/daxueshengkaoqin/upload/chengjiMuBan.xls"
                        >批量导入成绩数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('chengji','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column label="成绩编号" prop="chengjiUuidNumber" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.chengjiUuidNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column label="成绩标题" prop="chengjiName" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="分数" prop="chengjiFenshu" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.chengjiFenshu}}
                        </template>
                    </el-table-column>
                    <el-table-column label="成绩类型" prop="chengjiTypes" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.chengjiValue}}
                        </template>
                    </el-table-column>
                    <el-table-column label="发布时间" prop="insertTime" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
