        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/daxueshengkaoqin/upload/gonggaoMuBan.xls"
                        >批量导入公告数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('gonggao','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column label="公告名称" prop="gonggaoName" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.gonggaoName}}
                        </template>
                    </el-table-column>
                    <el-table-column label="公告图片" prop="gonggaoPhoto" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center" width="200">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="公告类型" prop="gonggaoTypes" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.gonggaoValue}}
                        </template>
                    </el-table-column>
                    <el-table-column label="公告发布时间" prop="insertTime" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
