    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="请假标题" prop="xueshengqingjiaName">
                       <el-input v-model="ruleForm.xueshengqingjiaName"
                                 placeholder="请假标题" clearable  :readonly="ro.xueshengqingjiaName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="请假标题" prop="xueshengqingjiaName">
                           <el-input v-model="ruleForm.xueshengqingjiaName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="请假缘由" prop="xueshengqingjiaText">
                        <el-input type="textarea"  :readonly="ro.xueshengqingjiaText" v-model="ruleForm.xueshengqingjiaText" placeholder="请假缘由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xueshengqingjiaText" label="请假缘由" prop="xueshengqingjiaText">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.xueshengqingjiaTime"  class="input" label="请假时间" prop="xueshengqingjiaTime">
                        <el-date-picker
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xueshengqingjiaYesnoTypes" label="申请状态" prop="xueshengqingjiaYesnoTypes">
                        <el-input v-model="ruleForm.xueshengqingjiaYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xueshengqingjiaYesnoText" label="处理意见" prop="xueshengqingjiaYesnoText">
                        <span v-html="ruleForm.xueshengqingjiaYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xueshengqingjiaShenheTime" label="审核时间" prop="xueshengqingjiaShenheTime">
                        <span v-html="ruleForm.xueshengqingjiaShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    xueshengqingjiaShenheTime: false,
                },
                ruleForm: {
                    xueshengId: '',
                    xueshengqingjiaName: '',
