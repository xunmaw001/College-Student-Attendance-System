    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(banji !=null){
            ...
            //级联表 老师
            //级联表
            LaoshiEntity laoshi = laoshiService.selectById(banji.getLaoshiId());
            if(laoshi != null){
    ...
    */
    ...
    public R save(@RequestBody BanjiEntity banji, HttpServletRequest request){
        ...
        if(false)
            ...
            banji.setLaoshiId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<BanjiEntity> queryWrapper = new EntityWrapper<BanjiEntity>()
            .eq("laoshi_id", banji.getLaoshiId())
            .eq("nianji_types", banji.getNianjiTypes())
...
//                            banjiEntity.setLaoshiId(Integer.valueOf(data.get(0)));   //老师 要改的
//                            banjiEntity.setBanjiUuidNumber(data.get(0));                    //班级编号 要改的
//                            banjiEntity.setNianjiTypes(Integer.valueOf(data.get(0)));   //年级 要改的
