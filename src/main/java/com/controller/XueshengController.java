    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(xuesheng !=null){
            ...
            if(banji != null){
            BeanUtils.copyProperties( banji , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "username", "password", "newMoney"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
...
//                            xueshengEntity.setJinyongTypes(Integer.valueOf(data.get(0)));   //账户状态 要改的
